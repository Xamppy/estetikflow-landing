      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          ...
          <motion.a
             ...
             whileTap={{ scale: 0.98 }}
             className="w-full sm:w-auto inline-flex items-center justify-center px-6 sm:px-8 py-4 sm:py-5 text-base sm:text-xl font-bold text-white bg-[#e76f51] rounded-full shadow-lg shadow-accent/30 hover:shadow-xl hover:shadow-accent/40 transition-colors duration-300 min-h-[48px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
          >
