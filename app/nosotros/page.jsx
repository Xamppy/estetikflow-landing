    ...
    <div className="min-h-screen flex flex-col bg-white font-sans">
      ...
      <section className="py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link
            href="/#contacto"
            className="inline-flex items-center gap-3 px-8 py-4 bg-[#e76f51] hover:bg-[#d65f41] text-white font-bold text-lg rounded-xl transition-colors duration-300 hover:scale-105 shadow-lg shadow-orange-500/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
          >
